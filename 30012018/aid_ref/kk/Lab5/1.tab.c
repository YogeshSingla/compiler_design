...
const int YY_parse_CLASS::KEYW=258;
const int YY_parse_CLASS::ID=259;
const int YY_parse_CLASS::CO=260;
const int YY_parse_CLASS::LP=261;
const int YY_parse_CLASS::RP=262;
const int YY_parse_CLASS::TE=263;
...
static const char * const yytname[] = {   "$","error","$illegal.","KEYW","ID",
"CO","LP","RP","TE","res","start","val",""
};
#endif
...
static const short yytable[] = {     1,
     4,     3,     6,    11,     5,     8,    13,     9,    10,    14
};

static const short yycheck[] = {     3,
     8,     4,     3,    10,     6,     4,     0,     7,     5,     0
};
